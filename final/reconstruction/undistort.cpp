...
void Undistort(Mat distorted_left_image, Mat distorted_right_image, 
    ...
    cv::undistort(distorted_left_image, undistorted_left_image, left_rgb_camera_matrix, left_rgb_distortion_coeffs, new_left_camera_matrix);
    cv::undistort(distorted_right_image, undistorted_right_image, right_rgb_camera_matrix, right_rgb_distortion_coeffs, new_right_camera_matrix);
